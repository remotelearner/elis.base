...
/**
 * Run the unit tests.
 * From: /admin/report/unittest/index.php
 *
...
$PAGE->requires->css('/admin/report/phpunittest/styles.css');
$PAGE->set_url('/admin/reports/phpunittest/index.php');
...
if ($async) { // force javascript not to wait for initial response!
    ...
    // Print the header.
    admin_externalpage_setup('report_phpunittest', '', array('showpasses' => $showpasses,
...
var updateurl = "{$CFG->wwwroot}/admin/report/phpunittest/update.php";
var filename;
var lasttftime = 0;
...
function run__tests( prev )
{
    ...
    if (document.phpunittest_form.async.checked == true) {
        ...
        if (window.review != true) {
            initurl = "{$CFG->wwwroot}/admin/report/phpunittest/index.php?async=1&filename=" + window.filename
